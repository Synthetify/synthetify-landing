const dictionary = {
  ...
  'faq.answers': [
    ...
    'SNY is only one of the tokens that will be used as a collateral and it is not required to use theexchange. That being said, it incorporates additional <a href="https://docs.synthetify.io/docs/synthetify-token#benefits">benefits</a>.',
