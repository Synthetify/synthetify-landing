const dictionary = {
  ...
  'faq.answers': [
    ...
    'SNY is only one of the tokens that will be used as a collateral and it is not required to use theexchange. That being said, it incorporates additional https://docs.synthetify.io/docs/synthetify-token#benefits.',
    'Minting is the process of creation of a synthetic asset. For more information, please see https://docs.synthetify.io/docs/glossary#mint.',
