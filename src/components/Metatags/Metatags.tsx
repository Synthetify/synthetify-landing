...
export const Metatags: React.FC = () => {
  const href: string = `https://${
    process.env.NEXT_PUBLIC_VERCEL_URL ?? 'synthetify.io'
  }/metatags.png`
  return (
    <Head>
      <meta charSet='utf-8' />
      ...
      <meta
        property='og:title'
        key='og:title'
        content='Synthetify - The Future of Synthetic Assests'
      />
      <meta
      ...
      <script async src='https://www.googletagmanager.com/gtag/js?id=G-Y61RVX1W4V'></script>
